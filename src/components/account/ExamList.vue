    ...
    <div id="pdf">
      ...
      <div class="tableContainer tableQuickSearchContainer">
        ...
        <el-table :data="insAccountList" style="width: 100%" >
          ...
          <el-table-column prop="createdAt" label="操作时间"  style="user-select:all;"></el-table-column>
        </el-table>
        <el-pagination
          v-if="total>10"
          class="pagination"
        ...
        >
          <div>
            <p class="account-mes">{{resetAccountInfo.institutionName}} 重置之后的账号密码如下</p>
            <p id="share-content">账号：{{resetAccountInfo.accountNum}} 密码：{{resetAccountInfo.password}}</p>
          </div>
      ...
      resetPassword(){
        ...
        resetPassword(this.resetPasswordParam).then(res=>{
          ...
          if (res && res.code === SUCCESS_CODE) {
            ...
            this.copyText = '账号：'+this.resetAccountInfo.accountNum +' '+'密码：'+this.resetAccountInfo.password
